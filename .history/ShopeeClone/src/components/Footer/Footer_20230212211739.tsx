      ...
      <div className='mx-auto lg:max-w-7xl'>
        <div className='my-8 grid grid-cols-5'>
          ...
          <div>
            ...
            <div>
              <div className='flex'>
                <img className='mr-4' src='https://cf.shopee.vn/file/2277b37437aa470fd1c71127c6ff8eb5' alt='' />
                <span>Facebook</span>
              </div>
              <div className='flex'>
                <img src='https://cf.shopee.vn/file/5973ebbc642ceee80a504a81203bfb91' alt='' />
                <span>Instagram</span>
              </div>
              <div className='flex'>
                <img src='https://cf.shopee.vn/file/f4f86f1119712b553992a75493065d9a' alt='' />
                <span>LinkedIn</span>
              </div>
            </div>
          </div>
