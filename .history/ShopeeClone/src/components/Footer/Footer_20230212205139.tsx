    ...
    <footer className='bg-neutral-100 py-16 text-[12px]'>
      <div className='mx-auto lg:max-w-7xl'>
        <div className='my-8 grid grid-cols-5'>
          <div>
            <div className='pb-3 font-bold uppercase text-zinc-800'>Chăm sóc khách hàng</div>
          ...
          <div>
            <div className='font-bold uppercase text-zinc-800'>Về Shopee</div>
            <div>Về Shopee</div>
            <div>Về Shopee</div>
            <div>Về Shopee</div>
            <div>Về Shopee</div>
          ...
          <div>
            <div className='font-bold uppercase text-zinc-800'>THANH TOÁN</div>
          </div>
          <div>
            <div className='font-bold uppercase text-zinc-800'>Theo dõi chúng tôi trên</div>
          </div>
          <div>
            <div className='font-bold uppercase text-zinc-800'>Tải ứng dụng Shopee ngay thôi</div>
          </div>
        </div>
        <div>
