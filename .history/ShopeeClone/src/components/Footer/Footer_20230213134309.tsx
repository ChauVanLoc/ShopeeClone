  ...
  return (
    <footer className='bg-neutral-100 py-16 text-[12px]'>
      <div className='mx-auto lg:max-w-7xl'>
        <div className='my-8 grid grid-cols-5 border-b border-gray-300 pb-7'>
          <div>
          ...
          <div>
            ...
            <div className='mt-6'>
              <div className='pb-4 font-bold uppercase text-zinc-800'>Đơn vị vận chuyển</div>
          ...
          <div>
            ...
            <div className='grid grid-cols-8'>
              <img
                className='col-span-3 rounded-sm shadow-lg'
                src='https://cf.shopee.vn/file/a5e589e8e118e937dc660f224b9a1472'
                alt='QR'
              />
              <div className='col-span-3 col-start-4 flex flex-col items-start justify-between'>
                <img
                  className='mb-1 rounded-sm bg-white px-1 pr-3 shadow-lg'
                  src='https://cf.shopee.vn/file/ad01628e90ddf248076685f73497c163'
                  alt='AppleStore'
                />
                <img
                  className='mb-1 bg-white px-2 shadow-lg'
        ...
        <div className='text-[12px] text-gray-500'>
          <div className='grid grid-cols-1 place-items-center gap-4 text-[14px] lg:flex lg:justify-between'>
          ...
          <div>CHÍNH SÁCH BẢO MẬT | QUY CHẾ HOẠT ĐỘNG | CHÍNH SÁCH VẬN CHUYỂN | CHÍNH SÁCH TRẢ HÀNG VÀ HOÀN TIỀN</div>
