        ...
        <div className='my-8 grid grid-cols-5'>
          ...
          <div>
            ...
            <div className='grid grid-cols-6'>
              <img className='col-span-2' src='https://cf.shopee.vn/file/a5e589e8e118e937dc660f224b9a1472' alt='QR' />
              <div className='grid grid-rows-3 bg-left'>
                <img src='https://cf.shopee.vn/file/ad01628e90ddf248076685f73497c163' alt='AppleStore' />
                <img src='https://cf.shopee.vn/file/ae7dced05f7243d0f3171f786e123def' alt='GG Play' />
                <img src='https://cf.shopee.vn/file/35352374f39bdd03b25e7b83542b2cb0' alt='AppGallery' />
              </div>
            </div>
          </div>
        </div>
