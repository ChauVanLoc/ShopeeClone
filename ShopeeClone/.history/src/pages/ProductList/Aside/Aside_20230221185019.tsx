      ...
      <div>
        ...
        <div className='flex flex-col text-[12px] capitalize'>
          ...
          <Link to={''} className='opacity-1 flex w-full items-center'>
            ...
            Áo Vest và BlazerÁo Vest và BlazerÁo Vest và BlazerÁo Vest và BlazerÁo Vest và BlazerÁo Vest và BlazerÁo
            Vest và BlazerÁo Vest và BlazerÁo Vest và BlazerÁo Vest và BlazerÁo Vest và Blazer
          </Link>
          <Link to={''} className='opacity-1 flex w-full items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
