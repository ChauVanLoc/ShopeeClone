      ...
      <div className='mb-10'>
        ...
        <div className='mb-7 border-b-[1px] pb-5'>
          ...
          <form className='mt-2' onSubmit={onSubmit}>
            ...
            <div className='text-red-600 mt-1 min-h-[1.25rem] text-center text-sm'>{errors.price_min?.message}</div>
            <input className='bg-orange hover:bg-orange/80 flex w-full items-center justify-center p-2 text-sm uppercase text-white'>
              Áp dụng
            </input>
          </form>
