  ...
  return (
    <div className='flex max-w-full flex-col py-3 pr-5 text-[12px]'>
      ...
      <div className='mb-10'>
        ...
        <div className='mb-7 max-w-full border-b-[1px] pb-5'>
          <div className='my-4'>Khoảng giá</div>
          <form className='mb-4 flex items-center pr-2'>
            <div className='flex max-w-full pr-2'>
              <input className='inline-block border' type='text' name='from' />
              <span className='ml-3'>-</span>
              <input className='inline-block border' type='text' name='to' />
            </div>
          </form>
        </div>
        <div className='mb-7 border-b-[1px] pb-5'>
