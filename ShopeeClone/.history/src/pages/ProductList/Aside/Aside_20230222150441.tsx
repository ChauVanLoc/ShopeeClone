    ...
    <div className='flex max-w-full flex-col py-3 text-[12px]'>
      ...
      <div className='mb-10'>
        ...
        <div className='mb-7 border-b-[1px] pb-5'>
          ...
          <form className='mb-4 flex items-center justify-evenly pr-2'>
            <input className='max-w-[40%] border' type='text' name='from' />
            <div className='ml-3 flex h-[1px] w-[5px] flex-shrink-0 bg-gray-500'></div>
            <input className='max-w-[40%] border' type='text' name='to' />
          </form>
        </div>
        <div className='mb-7 border-b-[1px] pb-5'>
          <div className='my-4'>Theo Danh Mục</div>
