    ...
    <div className='flex max-w-full flex-col py-3 pr-5 text-[12px]'>
      ...
      <div className='mb-10'>
        ...
        <Link to={''} className='mb-4 flex items-center pr-2'>
          ...
          <div className='ml-2 truncate'>Thời Trang Nam</div>
        </Link>
        <Link to={''} className='mb-4 flex items-center pr-2'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='ml-2 truncate'>Áo Khoác</div>
        </Link>
        <Link to={''} className='mb-4 flex items-center pr-2'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='ml-2 truncate'>Áo Vest và Blazer</div>
        </Link>
        <Link to={''} className='mb-4 flex items-center pr-2'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='ml-2 truncate'>Áo Hoodie, Áo Len & Áo Nỉ</div>
        </Link>
        <Link to={''} className='mb-4 flex items-center pr-2'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
          ...
          <div className='ml-2 truncate'>Quần Jeans</div>
        </Link>
        <Link to={''} className='flex items-center justify-end pr-2 text-[11px]'>
          <div className='mr-2 ml-2 truncate'>Thêm</div>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
