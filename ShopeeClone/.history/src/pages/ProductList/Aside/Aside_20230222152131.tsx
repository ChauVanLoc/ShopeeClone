        ...
        <div className='mb-7 border-b-[1px] pb-5'>
          ...
          <form className='mb-4 flex flex-col'>
            <div className='mb-4 flex items-center justify-between'>
              <input className='h-7 max-w-[43%] rounded-sm border px-3 outline-none' type='text' name='from' />
              <div className='h-[1px] w-[10px] bg-gray-500'></div>
              <input className='h-7 max-w-[43%] rounded-sm border px-3 outline-none' type='text' name='to' />
            </div>
