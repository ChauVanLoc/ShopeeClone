        ...
        <div className='mb-5 max-w-7xl text-sm shadow-sm'>
          <div className='rounded-ms flex bg-white'>
            ...
            <div className='w-[60%] px-9 py-3'>
              ...
              <div className='grid-col-5 grid grid-rows-7 place-items-center gap-y-4 px-7'>
                ...
                <div className='col-span-1 col-start-2 row-start-7 text-gray-500'>
                  <div className='flex items-center'>
                    <button className='rounded-sm border-y-[1px] border-l-[1px] border-gray-300 px-2 py-[6px]'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        fill='none'
                        viewBox='0 0 24 24'
                    ...
                    <div className='rounded-sm border-y-[1px] border-l-[1px] border-gray-300 px-3 text-center'>
                      <input className='w-14 px-3 py-1 outline-none' type='text' name='' id='' />
                    </div>
                ...
                <div className='col-span-1 col-start-3 row-start-7 flex items-center justify-center text-gray-500'>
                  11 sản phẩm có sẳn
                </div>
              </div>
            </div>
