            ...
            <div className='w-[60%] px-9 py-3'>
              ...
              <div className='grid-col-5 grid grid-rows-7 gap-y-4 px-7'>
                ...
                <div className='col-span-1 col-start-2 row-start-7 text-gray-500'>
                  <div className='flex items-center'>
                    <button className='rounded-sm border-[1px] border-gray-300 px-2 py-1'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        fill='none'
                        viewBox='0 0 24 24'
                    ...
                    <div className='rounded-sm border-[1px] border-gray-300 px-3 py-1 text-center'>
                      <input className='w-10 px-3 outline-none' type='text' name='' id='' />
                    </div>
                    <button className='rounded-sm border-[1px] border-gray-300 px-2 py-1'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
