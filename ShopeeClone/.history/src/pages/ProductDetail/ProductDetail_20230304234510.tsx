        ...
        <div className='mb-5 max-w-7xl text-sm shadow-sm'>
          <div className='rounded-ms flex bg-white'>
            ...
            <div className='w-[60%] px-9 py-3'>
              ...
              <div className='grid-col-5 grid grid-rows-7 px-5' style={{ display: 'flex', flexDirection: 'column' }}>
                <div className='col-span-4 col-start-1 row-start-1 h-auto overflow-auto'>Mã Giảm Giá Của Shop</div>
