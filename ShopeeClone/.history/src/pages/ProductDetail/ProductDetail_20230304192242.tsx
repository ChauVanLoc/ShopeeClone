      ...
      <div className='mx-auto max-w-7xl text-sm'>
        ...
        <div className='rounded-ms flex bg-white'>
          ...
          <div className='w-[60%] px-9 py-3'>
            ...
            <div className='mb-3 flex rounded-sm bg-[#FAFAFA] py-5 px-7'>
              <div className='mr-4 text-gray-300 line-through'>
                <span>₫</span>
                <span className='text-base'>399.000</span>
              </div>
              <div className='text-red'>
                <span>₫</span>
                <span className='text-2xl'>399.000</span>
              </div>
              <span className='bg-red px-1 text-white'>83% GIẢM</span>
            </div>
