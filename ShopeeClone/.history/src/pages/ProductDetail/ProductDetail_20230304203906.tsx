...
function ProductDetail() {
  ...
  return (
    <div className='bg-[#f5f5f5]'>
        ...
        <div className='grid grid-cols-12 gap-9'>
          ...
          <div className='col-span-7'>
            ...
            <div className='mt-8 flex items-center'>
              ...
              <div>
                <span>{convertDigitalNumber(product.sold)}</span>
                <span className='ml-1 text-gray-500'>Đã bán</span>
              </div>
            </div>
            <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
              <div className='text-gray-500 line-through'>₫{convertCurrentcy(product.price_before_discount)}</div>
              <div className='text-orange ml-3 text-3xl font-medium'>₫{convertCurrentcy(product.price)}</div>
      ...
      <div className='mx-auto mt-8 max-w-7xl bg-white p-4'>
