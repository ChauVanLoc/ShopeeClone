          ...
          <div className='rounded-ms flex bg-white'>
            <div className='flex w-[40%] flex-col py-3 pl-3'>
              ...
              <div className='grid grid-cols-5 gap-3'>
                <img
                  src='https://cf.shopee.vn/file/2803fbd9aa8fa12dee9c4da9d0e8f779_tn'
                  alt='imgsmall'
                  className='h-[82px]'
                />
                <img
            ...
            <div className='w-[60%] px-9 py-3'>
              ...
              <div className='grid-col-5 grid grid-rows-7 gap-y-4 px-7'>
                <div className='col-span-1 col-start-1 row-start-1'>Mã Giảm Giá Của Shop</div>
                <div className='col-span-4 col-start-2 row-start-1'>Giảm đ20</div>
                ...
                <div className='col-span-2 col-start-3 row-start-4'>
                  <div>Phường Linh Trung, Thành phố Thủ Đức</div>
                  <div>₫0 - ₫22.000</div>
                </div>
                <div className='col-span-1 col-start-1 row-start-5'>Size</div>
                ...
                <div className='col-span-2 col-start-2 row-start-6'>Bảng quy đổi kích cỡ</div>
                <div className='col-span-1 col-start-1 row-start-7'>Số Lượng</div>
                <div className='col-span-1 col-start-3 row-start-7'>11 sản phẩm có sẳn</div>
              </div>
            </div>
          </div>
        </div>
