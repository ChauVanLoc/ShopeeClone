            ...
            <div className='w-[60%] px-9 py-3'>
              ...
              <div className='grid-col-5 grid grid-rows-7 gap-y-2 px-7'>
                ...
                <div className='col-span-4 col-start-2 row-start-5'>
                  <div className='flex'>
                    <div className='mr-3 border border-2 px-3 py-2'>S (50-60kg)</div>
                    <div className='mr-3 border border-2 px-3 py-2'>M (60-70kg)</div>
                    <div className='mr-3 border border-2 px-3 py-2'>L (70-80kg)</div>
                    <div className=''>XL (80-95kg)</div>
                  </div>
                </div>
              </div>
            </div>
