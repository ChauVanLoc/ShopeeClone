...
import { AthResponve } from 'src/types/Ath.type'
...
export default function Register() {
  ...
  const registerMutation = useMutation({
    mutationFn: (body: RegisterSchemaType) => AuthFetching.registerAccountFetching(body)
  })
  const onSubmit = handleSubmit((data) => {
    registerMutation.mutate(data, {
      onError(error) {
        if (isUnprocessableEntityError<AthResponve<Omit<RegisterSchemaType, 'confirm_password'>>>(error)) {
