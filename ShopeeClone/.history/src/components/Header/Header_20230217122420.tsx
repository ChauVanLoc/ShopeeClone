                ...
                {isOpen && (
                  ...
                  >
                    <span
                      ...
                      ref={arrowRef}
                      className='translate-l-[-50%] translate-t-[-50%] absolute top-0 left-[50%] border-8 border-solid border-yellow-400 border-x-transparent border-t-transparent'
                    />
                    <div className={'z-0 flex flex-col rounded-sm bg-white py-3 px-3 text-gray-800'}>
                      <button className='mb-3'>Tiếng Việt</button>
