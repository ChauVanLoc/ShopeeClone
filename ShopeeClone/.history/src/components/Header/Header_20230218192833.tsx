            ...
            {isAuth ? (
              ...
              >
                <div className='flex flex-col rounded-sm bg-white text-sm shadow-sm'>
                  <div className='cursor-pointer py-[9px] pl-4 pr-12 capitalize hover:text-primary'>
                    Tài khoản của tôi
                  </div>
                  <div className='cursor-pointer py-[9px] pl-4 pr-12 capitalize hover:text-primary'>Đơn mua</div>
                  <div className='cursor-pointer py-[9px] pl-4 pr-12 capitalize hover:text-primary'>Đăng xuất</div>
                </div>
              </Popover>
            ) : (
              <>
