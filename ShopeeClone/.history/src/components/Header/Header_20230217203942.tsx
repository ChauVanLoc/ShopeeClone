...
'
                ...
                <div className='flex cursor-pointer items-center justify-between p-3 hover:bg-gray-200'>
                  <div className='p-3'>11 Thêm vào giỏ hàng</div>
                  <button className='bg-primary px-4 py-2 text-white'>Thêm vào giỏ hàng</button>
                </div>
              </div>
            </Popover>
          </div>
