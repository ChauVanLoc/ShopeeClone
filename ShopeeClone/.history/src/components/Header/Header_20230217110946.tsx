          ...
          <div className='flex flex-shrink-0'>
            ...
            <div>
              ...
              <FloatingPortal>
                {isOpen && (
                  <div
                    style={`x: ${middlewareData.arrow?.x}`, `x: ${middlewareData.arrow?.x}`,}
                    ref={arrowRef}
                    className='h-[6px] w-[6px] rotate-[135deg] border-[6px] border-solid border-gray-800 border-t-transparent border-r-transparent'
                  />
                )}
                {isOpen && (
                  <div
                    ...
                    className={'z-0 flex flex-col rounded-sm bg-white py-3 px-3 text-gray-800'}
                  >
