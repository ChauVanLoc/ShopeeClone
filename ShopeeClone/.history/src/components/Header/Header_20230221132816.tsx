    ...
    <div className='bg-header pt-1 pb-5'>
      <div className='mx-auto text-xs text-white lg:max-w-7xl'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='relative flex h-[40px] w-[840px]'>
            <input
              type='text'
              className='absolute top-0 left-0 h-full w-[86%] px-2 text-sm text-gray-600 outline-none'
              placeholder='Sale lên đến 90%'
            />
            <button className='absolute top-full right-0 flex items-center justify-center rounded-sm lg:h-[34px] lg:w-[55px] lg:bg-header'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
