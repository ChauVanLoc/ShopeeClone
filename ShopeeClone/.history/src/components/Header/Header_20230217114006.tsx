      ...
      <div className='mx-auto text-xs text-white lg:max-w-7xl'>
        <div className='mt-1 mb-3 flex justify-between'>
          ...
          <div className='flex flex-shrink-0'>
            ...
            <div>
              <Link onClick={popoverhandle} ref={refs.setReference} to={''} className={'flex flex-row px-3'}>
                Ngôn ngữ
              </Link>
              <FloatingPortal>
                {isOpen && (
                  ...
                  >
                    <span
                      ...
                      ref={arrowRef}
                      className='h-2 w-2 border-8 border-solid border-yellow-400 border-x-transparent border-t-transparent'
                    />
