      ...
      <div className='mx-auto text-xs text-white lg:max-w-7xl'>
        <div className='mt-1 mb-3 flex justify-between'>
          ...
          <div className='flex flex-shrink-0'>
            ...
            <div>
              <Link ref={refs.setReference} to={''} className={'flex flex-row items-center justify-center px-3'}>
                Ngôn ngữ
              </Link>
              <div
                ref={arrowRef}
                className='border-b-3 border-x-3 z-50 h-2 w-2 border-solid border-yellow-400 border-x-transparent border-x-transparent border-t-transparent'
              />
              <div
