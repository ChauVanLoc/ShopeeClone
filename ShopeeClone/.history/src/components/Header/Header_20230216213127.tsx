...
function Header() {
  return (
    <div className='bg-header'>
      <div className='mx-auto my-8 text-xs text-white lg:max-w-7xl'>
        ...
        <div className='flex justify-between'>
          ...
          <div className='flex flex-row lg:w-[50%]'>
            <div className='flex items-center justify-evenly lg:w-[80%] lg:bg-white'>
              <input type='text' className='w-[86%] text-lg text-black outline-none' />
              <button className='flex items-center justify-center lg:h-[34px] lg:w-[55px] lg:bg-header'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
