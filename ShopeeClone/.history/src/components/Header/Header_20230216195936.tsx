    ...
    <div className='mx-auto text-xs lg:max-w-7xl'>
      <div className='my-2 flex justify-between'>
        ...
        <div className='flex flex-shrink-0'>
          <Link to={''} className={'flex flex-row items-center justify-center py-2 px-3'}>
            <span className='mr-2'>
              <svg
          ...
          <Link to={''} className={'flex flex-row items-center justify-center border-r-[1px] py-2 px-3'}>
            Đăng Kí
          </Link>
          <Link to={''} className={'flex flex-row items-center justify-center py-2 px-3'}>
            Đăng Nhập
