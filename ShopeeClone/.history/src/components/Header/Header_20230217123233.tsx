...
import { useFloating, arrow, shift, offset } from '@floating-ui/react-dom'
    ...
    <div className='bg-header pt-1 pb-5'>
      <div className='mx-auto text-xs text-white lg:max-w-7xl'>
        <div className='mt-1 mb-3 flex justify-between'>
          ...
          <div className='ju flex flex-shrink-0 items-center'>
            ...
            <div ref={refs.setReference} onMouseEnter={onMouseEnterHandle} onMouseLeave={onMouseLeaveHandle}>
              <span className={'flex flex-row px-3'}>Ngôn ngữ</span>
              <FloatingPortal>
                {isOpen && (
                  <div
                  ...
                  >
                    <span
                      ...
                      ref={arrowRef}
                      className='translate-l-[-50%] absolute top-[-20%] left-[50%] border-8 border-solid border-white border-x-transparent border-t-transparent'
                    />
                    <div className={'flex flex-col rounded-sm bg-white text-gray-800'}>
                      <button className='px-2 py-1 hover:bg-slate-300'>Tiếng Việt</button>
                      <button className='py-1 px-2 hover:bg-slate-300'>Tiếng Anh</button>
                    </div>
                  </div>
                )}
              </FloatingPortal>
            ...
            <Link to={''} className={'flex flex-row items-center justify-center pl-3'}>
              Đăng Nhập
            </Link>
          </div>
        </div>
        <div className='flex justify-center'>
          ...
          <div className='flex flex-row justify-between lg:w-[50%]'>
            ...
            <div className='ml-4 self-baseline'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
