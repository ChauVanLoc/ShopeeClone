            ...
            {isAuth ? (
              ...
              >
                <div className='flex flex-col rounded-sm bg-white text-[12px] shadow-sm'>
                  <button className='cursor-pointer py-[15px] pl-3 pr-16 capitalize hover:bg-gray-100 hover:text-primary'>
                    Tài khoản của tôi
                  </button>
                  <button className='cursor-pointer pb-[9px] pl-3 pr-16 text-left capitalize hover:bg-gray-100 hover:text-primary'>
                    Đơn mua
                  </button>
                  <button
                    onClick={LogoutHandle}
                    className='cursor-pointer py-[9px] pl-3 pr-16 text-left capitalize hover:bg-gray-100 hover:text-primary'
                  >
                    Đăng xuất
                  </button>
                </div>
