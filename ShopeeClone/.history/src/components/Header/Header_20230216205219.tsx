...
function Header() {
  return (
    <div className='bg-header'>
      <div className='mx-auto text-xs text-[#FFF] lg:max-w-7xl'>
        ...
        <div className='flex justify-between'>
          <div className='flex flex-row pr-3 lg:w-[50%]'>
            <div className='lg:h-[45px] lg:w-[40px]'>
              <svg
            ...
            <div className='lg:h-[34px] lg:w-[165px]'>
