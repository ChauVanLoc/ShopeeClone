            ...
            {isAuth ? (
              ...
              >
                <div className='flex flex-col rounded-sm bg-white text-[12px] shadow-sm'>
                  <button className='cursor-pointer py-[15px] pl-3 pr-14 capitalize hover:bg-gray-100 hover:text-primary'>
                    Tài khoản của tôi
                  </button>
                  <button className='cursor-pointer py-[15px] pl-3 pr-14 text-left capitalize hover:bg-gray-100 hover:text-primary'>
                    Đơn mua
                  </button>
                  <button
