                ...
                {isOpen && (
                  ...
                  >
                    <span
                      ...
                      ref={arrowRef}
                      className='translate-l-[-50%] absolute top-[-13%] border-[6px] border-solid border-white border-x-transparent border-t-transparent'
                    />
                    <div className={'rounded-ms flex flex-col bg-white text-gray-800'}>
                      ...
                      <button className='px-2 pb-3 hover:text-header'>Tiếng Anh</button>
                    </div>
                  </div>
                )}
              </FloatingPortal>
