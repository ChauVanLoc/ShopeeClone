      ...
      <div className='mx-auto text-xs text-white lg:max-w-7xl'>
        ...
        <div className='flex justify-between'>
          ...
          <div className='flex flex-row lg:w-[50%]'>
            <div className='flex items-center justify-between bg-slate-500 lg:w-[80%]'>
              <input type='text' className='w-[90%] text-lg text-black outline-none' />
              <button className='lg:w-[46px] lg:bg-header'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
