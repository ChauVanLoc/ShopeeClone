      ...
      <div className='mx-auto text-xs text-white lg:max-w-7xl'>
        <div className='mt-1 mb-3 flex justify-between'>
          ...
          <div className='ju flex flex-shrink-0 items-center'>
            ...
            <div
              className='grid grid-cols-1 px-3 py-1'
                ...
                {isOpen && (
                  ...
                  >
                    <span
                      ...
                      ref={arrowRef}
                      className='translate-l-[-50%] absolute top-[-20%] left-[50%] border-[6px] border-solid border-white border-x-transparent border-t-transparent'
                    />
                    <div className={'rounded-ms flex flex-col bg-white text-gray-800'}>
                      <button className='px-3 py-2 hover:text-header'>Tiếng Việt</button>
                      <button className='py-3 px-2 hover:text-header'>Tiếng Anh</button>
                    </div>
                  </div>
                )}
              </FloatingPortal>
