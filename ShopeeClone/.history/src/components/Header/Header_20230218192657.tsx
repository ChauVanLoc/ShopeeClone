            ...
            {isAuth ? (
              ...
              >
                <div className='flex flex-col bg-white text-sm shadow-sm'>
                  <div className='cursor-pointer py-2 pl-4 pr-10 capitalize hover:text-primary'>Tài khoản của tôi</div>
                  <div className='cursor-pointer py-2 pl-4 pr-10 capitalize hover:text-primary'>Đơn mua</div>
                  <div className='cursor-pointer py-2 pl-4 pr-10 capitalize hover:text-primary'>Đăng xuất</div>
                </div>
              </Popover>
            ) : (
              <>
