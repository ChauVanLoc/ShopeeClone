        ...
        <div className='flex justify-center'>
          ...
          <div className='flex flex-row justify-between lg:w-[50%]'>
            ...
            <Popover
              ...
              classNameBlock={'ml-4 self-baseline'}
              classNameArrow={
                'translate-l-[-50%] absolute top-[-16%] border-[6px] border-solid border-white border-x-transparent border-t-transparent'
              }
            >
              <div className='flex flex-col rounded-sm bg-white text-sm shadow-sm'>
                <div className='capitalize text-gray-300'>Sản phẩm mới thêm</div>
...
'
                  ...
                  <div className='mx-3 h-[42px] w-[231px] truncate'>ghế bệt tựa lưng thư giãn d104 cao 72cm</div>
                  <div className='text-primary'>₫420.000</div>
                </div>
                <div className='flex capitalize'></div>
                <div className='flex capitalize'></div>
                <div className='flex capitalize'></div>
              </div>
            </Popover>
