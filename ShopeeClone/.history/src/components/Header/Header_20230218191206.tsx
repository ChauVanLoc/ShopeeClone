        ...
        <div className='mt-1 mb-3 flex justify-between'>
          ...
          <div className='flex flex-shrink-0 items-center'>
            ...
            {isAuth ? (
              ...
              >
                <div>
                  <div className='px-3 py-2 capitalize'>Tài khoản của tôi</div>
                  <div className='px-3 py-2 capitalize'>Đơn mua</div>
                  <div className='px-3 py-2 capitalize'>Đăng xuất</div>
                </div>
              </Popover>
            ) : (
              <>
