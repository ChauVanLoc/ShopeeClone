...
import { deleteAccessTokenToLS } from 'src/utils/auth'
            ...
            {isAuth ? (
              <Popover
                as={
                  <div className='flex'>
                    <svg
                      className='mr-2 h-[15px] w-[15px] rounded-full bg-white'
              ...
              >
                <div className='flex flex-col rounded-sm bg-white text-[12px] shadow-sm'>
                  <button className='cursor-pointer py-[9px] pl-3 pr-14 capitalize hover:bg-gray-100 hover:text-primary'>
                    Tài khoản của tôi
                  </button>
                  <button className='cursor-pointer py-[9px] pl-3 pr-14 text-left capitalize hover:bg-gray-100 hover:text-primary'>
                    Đơn mua
                  </button>
                  <button
                    onClick={exitHandle}
                    className='cursor-pointer py-[9px] pl-3 pr-14 text-left capitalize hover:bg-gray-100 hover:text-primary'
                  >
                    Đăng xuất
                  </button>
                </div>
