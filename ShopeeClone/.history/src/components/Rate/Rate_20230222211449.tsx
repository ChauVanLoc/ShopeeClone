  ...
  return (
    <Element className='relative'>
      ...
      <div className='absolute top-0 left-0 flex'>
        ...
        {rest > 0 && (
          <div className={`h-[10px] overflow-hidden fill-yellow-400`} style={{ width: '4px' }}>
            <svg className='h-[10px] w-[10px]' enableBackground='new 0 0 15 15' viewBox='0 0 15 15' role='img'>
              <path
                d='m7.5.8l2.2 4.6 4.8.5-3.8 3.2 1.1 5.1-4.3-2.6-4.3 2.6 1.1-5.1-3.8-3.2 4.8-.5z'
                strokeLinecap='round'
                strokeLinejoin='round'
